...
import { isValidExpression } from "@functions/manipulateExpression"
...
export function Input() {
  ...
  function validateEntry() {
    ...
    if (!isInvalid && config.automatic) handleResult()
  }
  ...
  return (
    <div className={`${firaCode.className} flex justify-center w-full`}>
      <input
        ...
        className="input border-2 border-r-0 text-2xl uppercase placeholder:normal-case border-slate-800 outline-none bg-inherit p-5 px-8 w-1/2 max-lg:w-9/12 max-sm:text-xl rounded-l-lg"
        onKeyUp={(e) => {
          handleInputEntry(e)
          validateEntry()
        }}
